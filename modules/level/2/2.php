        ...
        <?php if ($difficulte_histories['gagne'] != 1) { ?>
            ...
            <div id="level_<?= $_GET['level'] ?>">
                ...
                <div class="wrapper1">
                    ...
                    <table class='tbl' style="background: url('<?= $static_img . 'backgrounds/' . $level['background'] ?>') no-repeat center;background-position: center;">
                    </table>

                    <div class="mt-5">
                        <img src="<?= $static_img ?>level/logo_harry.png" style="max-width: 350px;" alt="">
                    </div>
                </div>
